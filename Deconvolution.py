...
print(TDOA(x, data_140x320, 48000))
...
#     # define matrix A
#     A = np.array([
#         [2 * np.transpose(x2 - x1), -2 * r12, 0, 0, 0],
#         [2 * np.transpose(x3 - x1), 0, -2 * r13, 0, 0],
#         [2 * np.transpose(x4 - x1), 0, 0, -2 * r14, 0],
#         [2 * np.transpose(x5 - x1), 0, 0, 0, -2 * r15],
#         [2 * np.transpose(x3 - x2), 0, -2 * r23, 0, 0],
#         [2 * np.transpose(x4 - x2), 0, 0, -2 * r24, 0],
#         [2 * np.transpose(x5 - x2), 0, 0, 0, -2 * r25],
#         [2 * np.transpose(x4 - x3), 0, 0, -2 * r34, 0],
#         [2 * np.transpose(x5 - x3), 0, 0, 0, -2 * r35],
#         [2 * np.transpose(x5 - x4), 0, 0, 0, -2 * r35]
#     ])
#
#     # magnitude / length
