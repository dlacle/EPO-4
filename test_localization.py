...
# xy
print('\ngenerated rangediff:\n',
      difference_to_location_xy(test_localization_xy(location), mic_positions_xy, 48000, 343.14),
      '\n')
print('real range diff:\n', difference_to_location_xy(diff, mic_positions_xy, 48000, 343.14))
# xyz
